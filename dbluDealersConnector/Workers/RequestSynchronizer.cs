...
namespace dbluDealersConnector.Workers
{
    ...
    public class RequestSynchronizer : BackgroundService
    {
        ...
        private TipiAllegati GetAttachType()
        {
            ...
            C.Attributi.Add(new Attributo() { Nome = "Riferimento", Descrizione = "Riferimenti", Alias = "Chiave2", Obbligatorio = false, Tipo = "System.String", Valore = "", SystemType = Type.GetType("System.String"), Visibilità = Visibilita_Attributi.VISIBLE, ValorePredefinito = "", Sequenza = "5" });            
            ...
            C.Attributi.Add(new Attributo() { Nome = "NumeroProtocollo", Descrizione = "Numero ordine eventuale di partenza", Alias = "Chiave5", Obbligatorio = false, Tipo = "System.String", Valore = "", SystemType = Type.GetType("System.String"), Visibilità = Visibilita_Attributi.VISIBLE, ValorePredefinito = "", Sequenza = "7" });
            ...
            C.Attributi.Add(new Attributo() { Nome = "CodiceSoggetto", Descrizione = "Codice Soggetto", Alias = "Chiave3", Obbligatorio = false, Tipo = "System.String", Valore = "", SystemType = Type.GetType("System.String"), Visibilità = Visibilita_Attributi.VISIBLE, ValorePredefinito = "", Sequenza = "10" });
            C.Attributi.Add(new Attributo() { Nome = "Data", Descrizione = "Data", Alias = "Chiave1", Obbligatorio = false, Tipo = "System.DateTime", Valore = "", SystemType = Type.GetType("System.DateTime"), Visibilità = Visibilita_Attributi.VISIBLE, ValorePredefinito = "", Sequenza = "11" });
            C.Attributi.Add(new Attributo() { Nome = "NomeSoggetto", Descrizione = "Nome Soggetto", Alias = "Chiave4", Obbligatorio = false, Tipo = "System.String", Valore = "", SystemType = Type.GetType("System.String"), Visibilità = Visibilita_Attributi.VISIBLE, ValorePredefinito = "", Sequenza = "12" });
